...
// node_modules/@rainbow-me/rainbowkit/dist/chunk-L3ELDJWW.js
...
var EmojiAvatar = ({ address, ensImage, size }) => {
  ...
  return ensImage ? import_react7.default.createElement(Box, {
    backgroundSize: "cover",
    borderRadius: "full",
    position: "absolute",
    style: {
...
var useRainbowKitChains = () => (0, import_react9.useContext)(RainbowKitChainContext);
...
function useWalletConnectors() {
  ...
  groupedWallets.forEach((wallet2) => {
    ...
    walletConnectors.push({
      ...
      ready: ((_a2 = wallet2.installed) != null ? _a2 : true) && wallet2.connector.ready,
      recent,
...
var AppContext = (0, import_react17.createContext)(defaultAppInfo);
var CoolModeContext = (0, import_react18.createContext)(false);
var ShowRecentTransactionsContext = (0, import_react19.createContext)(false);
var arbitrumIcon = {
...
var ThemeIdContext = (0, import_react16.createContext)(void 0);
var attr = "data-rk";
...
var useThemeRootProps = () => {
  const id = (0, import_react16.useContext)(ThemeIdContext);
...
function RainbowKitProvider({
  ...
  const rainbowkitChains = (0, import_react16.useMemo)(() => provideRainbowKitChains(chains), [chains]);
  ...
  return import_react16.default.createElement(RainbowKitChainContext.Provider, {
    value: rainbowkitChains
  }, import_react16.default.createElement(CoolModeContext.Provider, {
    value: coolMode
  }, import_react16.default.createElement(ShowRecentTransactionsContext.Provider, {
    value: showRecentTransactions
  }, import_react16.default.createElement(TransactionStoreProvider, null, import_react16.default.createElement(AvatarContext.Provider, {
    value: avatarContext
  }, import_react16.default.createElement(AppContext.Provider, {
    value: appContext
  }, import_react16.default.createElement(ThemeIdContext.Provider, {
    value: id
  }, theme ? import_react16.default.createElement("div", {
    ...createThemeRootProps(id)
  }, import_react16.default.createElement("style", {
...
function FocusTrap(props) {
  ...
  return import_react20.default.createElement(import_react20.default.Fragment, null, import_react20.default.createElement("div", {
    onFocus: (0, import_react20.useCallback)(() => contentRef.current && moveFocusWithin(contentRef.current, "end"), []),
    tabIndex: 0
    ...
    onFocus: (0, import_react20.useCallback)(() => contentRef.current && moveFocusWithin(contentRef.current, "start"), []),
    tabIndex: 0
  }));
}
...
function Dialog({ children, onClose, open, titleId }) {
  ...
  const handleBackdropClick = (0, import_react15.useCallback)(() => onClose(), [onClose]);
  const themeRootProps = useThemeRootProps();
  const mobile = isMobile();
  return import_react15.default.createElement(import_react15.default.Fragment, null, open ? (0, import_react_dom.createPortal)(import_react15.default.createElement(Combination_default, null, import_react15.default.createElement(Box, {
    ...themeRootProps
  }, import_react15.default.createElement(Box, {
    ...themeRootProps,
    ...
    position: "fixed",
    role: "dialog"
  }, import_react15.default.createElement(FocusTrap, {
    className: content,
...
var CloseIcon = () => {
  return isMobile() ? import_react24.default.createElement("svg", {
    "aria-hidden": true,
    fill: "none",
    height: "11.5",
...
var CloseButton = ({
  ...
  const mobile = isMobile();
  return import_react23.default.createElement(Box, {
    alignItems: "center",
    ...
    type: "button",
    width: mobile ? "30" : "28"
  }, import_react23.default.createElement(CloseIcon, null));
};
...
var CopiedIcon = () => import_react25.default.createElement("svg", {
  fill: "none",
  height: "13",
  viewBox: "0 0 13 13",
  width: "13",
...
var CopyIcon = () => import_react26.default.createElement("svg", {
  fill: "none",
  height: "16",
  viewBox: "0 0 17 16",
  width: "17",
...
var DisconnectIcon = () => import_react27.default.createElement("svg", {
  fill: "none",
  height: "16",
  viewBox: "0 0 18 16",
  width: "18",
...
var Text = import_react28.default.forwardRef(({
  as = "div",
  children,
  className,
  color,
...
var ExternalLinkIcon = () => import_react31.default.createElement("svg", {
  fill: "none",
  height: "19",
  viewBox: "0 0 20 19",
  width: "20",
...
var CancelIcon = () => import_react33.default.createElement("svg", {
  fill: "none",
  height: "19",
  viewBox: "0 0 20 19",
  width: "20",
...
var SuccessIcon = () => import_react34.default.createElement("svg", {
  fill: "none",
  height: "20",
  viewBox: "0 0 20 20",
  width: "20",
...
function TxItem({ tx }) {
  ...
  return import_react32.default.createElement(import_react32.default.Fragment, null, import_react32.default.createElement(Box, {
    ...explorerLink ? {
      as: "a",
    ...
    padding: "8",
    width: "full"
  }, import_react32.default.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "row",
    gap: mobile ? "16" : "14"
    ...
    color
  }, import_react32.default.createElement(Icon, null)), import_react32.default.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: mobile ? "3" : "1"
  }, import_react32.default.createElement(Box, null, import_react32.default.createElement(Text, {
    color: "modalText",
    font: "body",
    size: mobile ? "16" : "14",
    weight: "bold"
  }, tx == null ? void 0 : tx.description)), import_react32.default.createElement(Box, null, import_react32.default.createElement(Text, {
    color: tx.status === "pending" ? "modalTextSecondary" : color,
    font: "body",
    size: "14",
    weight: mobile ? "medium" : "regular"
  }, confirmationStatus)))), explorerLink && import_react32.default.createElement(Box, {
    alignItems: "center",
    color: "modalTextDim",
    display: "flex"
  }, import_react32.default.createElement(ExternalLinkIcon, null))));
}
...
function TxList({ address }) {
  ...
  const mobile = isMobile();
  const { appName } = (0, import_react29.useContext)(AppContext);
  return import_react29.default.createElement(import_react29.default.Fragment, null, import_react29.default.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "10",
    paddingBottom: "2",
  ...
  }, hasTransactions && import_react29.default.createElement(Box, {
    ...
    display: "flex",
    justifyContent: "space-between"
  }, import_react29.default.createElement(Text, {
    color: "modalTextSecondary",
    size: mobile ? "16" : "14",
    weight: "semibold"
  }, "Recent Transactions"), import_react29.default.createElement(Box, {
    style: {
      marginBottom: -6,
      marginLeft: -10,
      marginRight: -10,
    ...
    size: mobile ? "16" : "14",
    weight: "semibold"
  }, "Clear All"))))), import_react29.default.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "4"
  }, hasTransactions ? visibleTxs.map((tx) => import_react29.default.createElement(TxItem, {
    key: tx.hash,
    tx
  })) : import_react29.default.createElement(import_react29.default.Fragment, null, import_react29.default.createElement(Box, {
    padding: mobile ? "12" : "8"
  }, import_react29.default.createElement(Text, {
    color: "modalTextDim",
    size: mobile ? "16" : "14",
    weight: mobile ? "medium" : "bold"
  }, appName != null ? appName : "Your", " transactions will appear here...")), mobile && import_react29.default.createElement(Box, {
    background: "generalBorderDim",
    height: "1",
    marginX: "12",
    marginY: "8"
  })))), explorerLink && import_react29.default.createElement(Box, {
    paddingBottom: "18",
    paddingX: mobile ? "8" : "18"
  }, import_react29.default.createElement(Box, {
    alignItems: "center",
  ...
  }, "View more on Explorer"), import_react29.default.createElement(ExternalLinkIcon, null))));
}
function ProfileDetailsAction({
  ...
  return import_react35.default.createElement(Box, {
    ...
    color: "modalText",
    height: "max"
  }, icon), import_react35.default.createElement(Box, null, import_react35.default.createElement(Text, {
    color: "modalText",
    size: mobile ? "12" : "13",
    weight: "semibold"
  }, label))));
...
function ProfileDetails({
  ...
  const showRecentTransactions = (0, import_react22.useContext)(ShowRecentTransactionsContext);
  const [copiedAddress, setCopiedAddress] = (0, import_react22.useState)(false);
  const copyAddressAction = (0, import_react22.useCallback)(() => {
    if (address) {
  ...
  const mobile = isMobile();
  return import_react22.default.createElement(import_react22.default.Fragment, null, import_react22.default.createElement(Box, {
    display: "flex",
    flexDirection: "column"
  ...
  }, import_react22.default.createElement(CloseButton, {
    onClose
  })), " ", import_react22.default.createElement(Box, {
    marginTop: mobile ? "24" : "0"
  }, import_react22.default.createElement(Avatar, {
    address,
    imageUrl: ensAvatar,
    size: mobile ? 82 : 74
  })), import_react22.default.createElement(Box, {
    ...
    size: mobile ? "20" : "18",
    weight: "heavy"
  }, accountName)), balanceData && import_react22.default.createElement(Box, {
    textAlign: "center"
  }, import_react22.default.createElement(Text, {
    as: "h1",
    color: "modalTextSecondary",
    ...
    size: mobile ? "16" : "14",
    weight: "semibold"
  }, balance, " ", balanceData.symbol)))), import_react22.default.createElement(Box, {
    display: "flex",
    flexDirection: "row",
    gap: "8",
    margin: "2",
    marginTop: "16"
  }, import_react22.default.createElement(ProfileDetailsAction, {
    action: copyAddressAction,
    icon: copiedAddress ? import_react22.default.createElement(CopiedIcon, null) : import_react22.default.createElement(CopyIcon, null),
    label: copiedAddress ? "Copied!" : "Copy Address"
  }), import_react22.default.createElement(ProfileDetailsAction, {
    action: onDisconnect,
    icon: import_react22.default.createElement(DisconnectIcon, null),
    label: "Disconnect"
  }))), showRecentTransactions && import_react22.default.createElement(import_react22.default.Fragment, null, import_react22.default.createElement(Box, {
    background: "generalBorder",
    height: "1",
    marginTop: "-1"
  }), import_react22.default.createElement(Box, null, import_react22.default.createElement(TxList, {
    address
  })))));
}
function AccountModal({
  ...
  return import_react14.default.createElement(import_react14.default.Fragment, null, address && import_react14.default.createElement(Dialog, {
    onClose,
    open,
    titleId
  }, import_react14.default.createElement(DialogContent, {
    bottomSheetOnMobile: true,
    padding: "0"
  }, import_react14.default.createElement(ProfileDetails, {
    address,
    balanceData,
    ensAvatar,
    ensName,
...
var DisconnectSqIcon = ({ size }) => import_react37.default.createElement("svg", {
  fill: "none",
  height: size,
  viewBox: "0 0 28 28",
  width: size,
...
var MenuButton = import_react38.default.forwardRef(({ children, currentlySelected = false, onClick, ...urlProps }, ref) => {
  const mobile = isMobile();
  return import_react38.default.createElement(Box, {
    as: "button",
    borderRadius: "menuButton",
...
function ChainModal({
  ...
  const [switchingToChain, setSwitchingToChain] = (0, import_react36.useState)();
  ...
  const stopSwitching = (0, import_react36.useCallback)(() => {
  ...
  const { appName } = (0, import_react36.useContext)(AppContext);
  if (!activeChain || !(activeChain == null ? void 0 : activeChain.id)) {
    return null;
  }
  return import_react36.default.createElement(Dialog, {
    onClose,
    open,
    titleId
  }, import_react36.default.createElement(DialogContent, {
    bottomSheetOnMobile: true
    ...
    flexDirection: "row",
    justifyContent: "space-between"
  }, mobile && import_react36.default.createElement(Box, {
    width: "30"
  }), import_react36.default.createElement(Box, {
    paddingBottom: "0",
    paddingLeft: "8",
    paddingTop: "4"
  }, import_react36.default.createElement(Text, {
    as: "h1",
    color: "modalText",
    id: titleId,
    size: mobile ? "20" : "18",
    weight: "heavy"
  }, "Switch Networks")), import_react36.default.createElement(CloseButton, {
    onClose
  })), unsupportedChain && import_react36.default.createElement(Box, {
    marginX: "8",
    ...
    size: "14",
    weight: "medium"
  }, "Wrong network detected, switch or disconnect to continue.")), import_react36.default.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "4",
    padding: "2"
    ...
    return import_react36.default.createElement(import_react36.Fragment, {
      key: chain.id
    }, import_react36.default.createElement(MenuButton, {
    ...
    }, chainIconUrl ? import_react36.default.createElement(Box, {
      height: "full",
      marginRight: "8"
    }, import_react36.default.createElement(AsyncImage, {
      alt: chain.name,
    ...
    })) : null, import_react36.default.createElement("div", null, chain.name)), isCurrentChain && import_react36.default.createElement(Box, {
      alignItems: "center",
      display: "flex",
      flexDirection: "row",
      marginRight: "6"
      ...
      size: "14",
      weight: "medium"
    }, "Connected"), import_react36.default.createElement(Box, {
      ...
      marginLeft: "8",
      width: "8"
    })), switching && import_react36.default.createElement(Box, {
      alignItems: "center",
      display: "flex",
      flexDirection: "row",
      marginRight: "6"
      ...
      size: "14",
      weight: "medium"
    }, "Confirm in Wallet"), import_react36.default.createElement(Box, {
      background: "standby",
      borderRadius: "full",
      height: "8",
      marginLeft: "8",
      width: "8"
    }))))), mobile && idx < (chains == null ? void 0 : chains.length) - 1 && import_react36.default.createElement(Box, {
      background: "generalBorderDim",
      height: "1",
      marginX: "8"
    }));
    ...
    size: "14",
    weight: "medium"
  }, "Your wallet does not support switching networks from", " ", appName != null ? appName : "this app", ". Try switching networks from within your wallet instead.")), unsupportedChain && import_react36.default.createElement(import_react36.default.Fragment, null, import_react36.default.createElement(Box, {
    background: "generalBorderDim",
    height: "1",
    marginX: "8"
  }), import_react36.default.createElement(MenuButton, {
    ...
    justifyContent: "center",
    marginRight: "8"
  }, import_react36.default.createElement(DisconnectSqIcon, {
    size: Number(chainIconSize)
  })), import_react36.default.createElement("div", null, "Disconnect"))))))))));
}
function isSafari() {
...
var DisclaimerLink = ({
  ...
  return import_react44.default.createElement(Box, {
    as: "a",
    color: "accentColor",
    href,
    rel: "noreferrer",
...
var DisclaimerText = ({ children }) => {
  return import_react45.default.createElement(Text, {
    color: "modalTextSecondary",
    size: "12",
    weight: "medium"
  }, children);
...
var AssetsIcon = () => import_react46.default.createElement(AsyncImage, {
  background: "#d0d5de",
  borderRadius: "10",
  height: "48",
  src,
...
var LoginIcon = () => import_react47.default.createElement(AsyncImage, {
  background: "#d0d5de",
  borderRadius: "10",
  height: "48",
  src: src2,
...
function ConnectModalIntro({ getWallet }) {
  const { disclaimer: Disclaimer, learnMoreUrl } = (0, import_react42.useContext)(AppContext);
  return import_react42.default.createElement(import_react42.default.Fragment, null, import_react42.default.createElement(Box, {
    ...
    size: "18",
    weight: "heavy"
  }, "What is a Wallet?")), import_react42.default.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "32",
    justifyContent: "center",
    ...
    minWidth: "48",
    width: "48"
  }, import_react42.default.createElement(AssetsIcon, null)), import_react42.default.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "4"
  }, import_react42.default.createElement(Text, {
    ...
    size: "14",
    weight: "bold"
  }, "A Home for your Digital Assets"), import_react42.default.createElement(Text, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
  }, "Wallets are used to send, receive, store, and display digital assets like Ethereum and NFTs."))), import_react42.default.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "row",
    gap: "16"
    ...
    minWidth: "48",
    width: "48"
  }, import_react42.default.createElement(LoginIcon, null)), import_react42.default.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "4"
  }, import_react42.default.createElement(Text, {
    ...
    size: "14",
    weight: "bold"
  }, "A New Way to Log In"), import_react42.default.createElement(Text, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
  }, "Instead of creating new accounts and passwords on every website, just connect your wallet.")))), import_react42.default.createElement(Box, {
    alignItems: "center",
    display: "flex",
    flexDirection: "column",
    gap: "12",
    justifyContent: "center",
    margin: "10"
  }, import_react42.default.createElement(ActionButton, {
    label: "Get a Wallet",
    onClick: getWallet
  }), import_react42.default.createElement(Box, {
    as: "a",
    ...
    size: "14",
    weight: "bold"
  }, "Learn More"))), Disclaimer && import_react42.default.createElement(Box, {
    marginBottom: "8",
    marginTop: "12",
    textAlign: "center"
  }, import_react42.default.createElement(Disclaimer, {
    Link: DisclaimerLink,
    Text: DisclaimerText
  }))));
}
var BackIcon = () => import_react48.default.createElement("svg", {
  fill: "none",
  height: "17",
  viewBox: "0 0 11 17",
  width: "11",
...
var useCoolMode = (imageUrl) => {
  ...
  const coolModeEnabled = (0, import_react50.useContext)(CoolModeContext);
...
var ModalSelection = ({
  ...
  const [isMouseOver, setIsMouseOver] = (0, import_react49.useState)(false);
  return import_react49.default.createElement(Box, {
    ...
    src: iconUrl,
    width: "28"
  }), import_react49.default.createElement("div", null, name)))));
};
ModalSelection.displayName = "ModalSelection";
var useWindowSize = () => {
  const [windowSize, setWindowSize] = (0, import_react52.useState)({
...
var CreateIcon = () => import_react53.default.createElement(AsyncImage, {
  background: "#e3a5e8",
  height: "48",
  src: src3,
  width: "48"
...
var ScanIcon = () => import_react54.default.createElement(AsyncImage, {
  background: "#515a70",
  height: "48",
  src: src4,
  width: "48"
...
function QRCode({
  ...
  const dots = (0, import_react55.useMemo)(() => {
    const dots2 = [];
    ...
    qrList.forEach(({ x, y }) => {
      ...
      for (let i = 0; i < 3; i++) {
        dots2.push(import_react55.default.createElement("rect", {
        ...
        if (matrix[i][j]) {
          if (!(i < 7 && j < 7 || i > matrix.length - 8 && j < 7 || i < 7 && j > matrix.length - 8)) {
            if (!(i > matrixMiddleStart && i < matrixMiddleEnd && j > matrixMiddleStart && j < matrixMiddleEnd)) {
              dots2.push(import_react55.default.createElement("circle", {
  ...
  return import_react55.default.createElement(Box, {
    ...
    width: "full"
  }, import_react55.default.createElement(AsyncImage, {
    ...
    style: { all: "revert" },
    width: size
  }, import_react55.default.createElement("defs", null, import_react55.default.createElement("clipPath", {
    id: "clip-wrapper"
  }, import_react55.default.createElement("rect", {
    height: logoWrapperSize,
    width: logoWrapperSize
  })), import_react55.default.createElement("clipPath", {
    id: "clip-logo"
  }, import_react55.default.createElement("rect", {
    height: logoSize,
    width: logoSize
...
function GetDetail({
  ...
  return import_react51.default.createElement(Box, {
    ...
    return import_react51.default.createElement(Box, {
      ...
      flexDirection: "row",
      gap: "16"
    }, import_react51.default.createElement(AsyncImage, {
      background: iconBackground,
      borderColor: "actionButtonBorder",
      borderRadius: "10",
      height: "48",
      ...
      flexDirection: "column",
      gap: "2"
    }, import_react51.default.createElement(Text, {
      color: "modalText",
      size: "14",
      weight: "bold"
    }, name), import_react51.default.createElement(Text, {
      color: "modalTextSecondary",
      size: "14",
      weight: "medium"
    }, hasMobileCompanionApp ? "Mobile Wallet" : (downloadUrls == null ? void 0 : downloadUrls.browserExtension) ? "Browser Extension" : null))), import_react51.default.createElement(Box, {
      display: "flex",
      flexDirection: "column",
      gap: "4"
    }, import_react51.default.createElement(ActionButton, {
      label: "GET",
    ...
    size: "14",
    weight: "bold"
  }, "Not what you\u2019re looking for?"), import_react51.default.createElement(Text, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
...
function ConnectDetail({
  ...
  return import_react51.default.createElement(Box, {
    ...
    height: "full",
    width: "full"
  }, qrCode && qrCodeUri ? import_react51.default.createElement(Box, {
    alignItems: "center",
    display: "flex",
    height: "full",
    justifyContent: "center"
  }, import_react51.default.createElement(QRCode, {
    ...
    size: "20",
    weight: "bold"
  }, ready ? `Opening ${name}` : (downloadUrls == null ? void 0 : downloadUrls.browserExtension) ? `${name} is not installed` : `${name} is not available`), import_react51.default.createElement(Box, {
    color: "modalTextSecondary",
    display: "flex",
    flexDirection: "row",
    gap: "6",
    height: "24"
  }, connectionError ? import_react51.default.createElement(Text, {
    color: "error",
    size: "16",
    textAlign: "center",
    weight: "bold"
  }, "Error connecting, please retry!") : import_react51.default.createElement(import_react51.default.Fragment, null, ready ? import_react51.default.createElement(SpinnerIcon, null) : null, import_react51.default.createElement(Text, {
    color: "modalTextSecondary",
    size: "16",
    textAlign: "center",
    weight: "bold"
  }, readyMsg))), !ready && (downloadUrls == null ? void 0 : downloadUrls.browserExtension) ? import_react51.default.createElement(Box, {
    paddingTop: "20"
  }, import_react51.default.createElement(ActionButton, {
    href: downloadUrls.browserExtension,
    label: "INSTALL",
    type: "secondary"
  })) : null))), import_react51.default.createElement(Box, {
    alignItems: "center",
    borderRadius: "10",
    display: "flex",
    flexDirection: "row",
    ...
    justifyContent: "space-between",
    marginTop: "12"
  }, !ready ? null : import_react51.default.createElement(import_react51.default.Fragment, null, import_react51.default.createElement(Text, {
    color: "modalTextSecondary",
    size: "14",
    weight: "medium"
  }, secondaryAction.description), import_react51.default.createElement(ActionButton, {
...
function DownloadDetail({
  ...
  return import_react51.default.createElement(Box, {
    ...
    size: "14",
    weight: "semibold"
  }, "Scan with your phone to download on iOS or Android")), import_react51.default.createElement(Box, {
    height: "full"
  }, (downloadUrls == null ? void 0 : downloadUrls.qrCode) ? import_react51.default.createElement(QRCode, {
    logoSize: 0,
    size: 268,
...
var stepIcons = {
  create: () => import_react51.default.createElement(CreateIcon, null),
  install: (wallet2) => import_react51.default.createElement(AsyncImage, {
  ...
  scan: () => import_react51.default.createElement(ScanIcon, null)
};
function InstructionDetail({
  ...
  return import_react51.default.createElement(Box, {
    ...
    return import_react51.default.createElement(Box, {
      ...
      position: "relative",
      width: "48"
    }, (_a2 = stepIcons[d.step]) == null ? void 0 : _a2.call(stepIcons, wallet2)), import_react51.default.createElement(Box, {
      display: "flex",
      flexDirection: "column",
      gap: "4"
    }, import_react51.default.createElement(Text, {
      ...
      size: "14",
      weight: "bold"
    }, d.title), import_react51.default.createElement(Text, {
      color: "modalTextSecondary",
      size: "14",
      weight: "medium"
    }, d.description)));
...
function DesktopOptions({ onClose }) {
  ...
  const safari = isSafari();
  const [selectedOptionId, setSelectedOptionId] = (0, import_react41.useState)();
  const [selectedWallet, setSelectedWallet] = (0, import_react41.useState)();
  const [qrCodeUri, setQrCodeUri] = (0, import_react41.useState)();
  const hasQrCode = !!(selectedWallet == null ? void 0 : selectedWallet.qrCode);
  const [connectionError, setConnectionError] = (0, import_react41.useState)(false);
  ...
  const [initialWalletStep, setInitialWalletStep] = (0, import_react41.useState)("NONE");
  const [walletStep, setWalletStep] = (0, import_react41.useState)("NONE");
  ...
  switch (walletStep) {
    case "NONE":
      walletContent = import_react41.default.createElement(ConnectModalIntro, {
        getWallet: () => changeWalletStep("GET")
      });
      break;
    case "GET":
      walletContent = import_react41.default.createElement(GetDetail, {
        getMobileWallet
      });
      ...
      break;
    case "CONNECT":
      walletContent = selectedWallet && import_react41.default.createElement(ConnectDetail, {
        changeWalletStep,
        connectionError,
        qrCodeUri,
      ...
      break;
    case "DOWNLOAD":
      walletContent = selectedWallet && import_react41.default.createElement(DownloadDetail, {
        changeWalletStep,
        wallet: selectedWallet
      });
      ...
      break;
    case "INSTRUCTIONS":
      walletContent = selectedWallet && import_react41.default.createElement(InstructionDetail, {
  ...
  return import_react41.default.createElement(Box, {
    display: "flex",
    flexDirection: "row",
    style: { maxHeight: 504 }
    ...
    size: "18",
    weight: "heavy"
  }, "Connect a Wallet")), import_react41.default.createElement(Box, {
    className: ScrollClassName,
    paddingBottom: "18"
  }, Object.entries(groupedWallets).map(([groupName, wallets2], index) => wallets2.length > 0 && import_react41.default.createElement(import_react41.Fragment, {
    key: index
  }, groupName ? import_react41.default.createElement(Box, {
    marginBottom: "8",
    marginTop: "16",
    marginX: "6"
  }, import_react41.default.createElement(Text, {
    ...
    size: "14",
    weight: "bold"
  }, groupName)) : null, import_react41.default.createElement(Box, {
    display: "flex",
    flexDirection: "column",
    gap: "4"
  }, wallets2.map((wallet2) => {
    return import_react41.default.createElement(ModalSelection, {
  ...
  })))))), !isMobile() && import_react41.default.createElement(import_react41.default.Fragment, null, import_react41.default.createElement(Box, {
    background: "generalBorder",
    minWidth: "1",
    width: "1"
  }), import_react41.default.createElement(Box, {
    ...
    width: "28"
  }, headerBackButtonLink && import_react41.default.createElement(Box, {
    as: "button",
    className: touchableStyles({
      active: "shrinkSm",
      hover: "growLg"
    ...
    transition: "default",
    type: "button"
  }, import_react41.default.createElement(BackIcon, null))), import_react41.default.createElement(Box, {
    display: "flex",
    justifyContent: "center",
    style: { flexGrow: 1 }
  }, headerLabel && import_react41.default.createElement(Text, {
    color: "modalText",
    size: "18",
    textAlign: "center",
    weight: "heavy"
  }, headerLabel)), import_react41.default.createElement(CloseButton, {
    onClose
  })), import_react41.default.createElement(Box, {
    display: "flex",
    flexDirection: "column",
...
function WalletButton({ wallet: wallet2 }) {
  ...
  return import_react56.default.createElement(Box, {
    ...
    fontFamily: "body",
    key: id,
    onClick: (0, import_react56.useCallback)(async () => {
    ...
    as: "span",
    position: "relative"
  }, shortName != null ? shortName : name, !wallet2.ready && " (unsupported)")), wallet2.recent && import_react56.default.createElement(Text, {
    color: "accentColor",
    size: "12",
    weight: "medium"
  }, "Recent"))));
...
function MobileOptions({ onClose }) {
  ...
  const titleId = "rk_connect_title";
  const wallets = useWalletConnectors();
  const { disclaimer: Disclaimer, learnMoreUrl } = (0, import_react56.useContext)(AppContext);
  let headerLabel = null;
  let walletContent = null;
  let headerBackgroundContrast = false;
  let headerBackButtonLink = null;
  const [walletStep, setWalletStep] = (0, import_react56.useState)("CONNECT");
  const ios = isIOS();
  switch (walletStep) {
    case "CONNECT": {
      headerLabel = "Connect a Wallet";
      headerBackgroundContrast = true;
      walletContent = import_react56.default.createElement(Box, null, import_react56.default.createElement(Box, {
        background: "profileForeground",
        className: scroll,
        display: "flex",
        paddingBottom: "20",
        ...
        return import_react56.default.createElement(Box, {
          ...
          width: "60"
        }, import_react56.default.createElement(WalletButton, {
          wallet: wallet2
        })));
      }))), import_react56.default.createElement(Box, {
        background: "generalBorder",
        ...
        size: "16",
        weight: "bold"
      }, "What is a Wallet?"), import_react56.default.createElement(Text, {
        color: "modalTextSecondary",
        size: "16"
      }, "A wallet is used to send, receive, store, and display digital assets. It\u2019s also a new way to log in, without needing to create new accounts and passwords on\xA0every\xA0website."))), import_react56.default.createElement(Box, {
        paddingTop: "32",
        paddingX: "20"
      }, import_react56.default.createElement(Box, {
        display: "flex",
        ...
        size: "large",
        type: "secondary"
      }))), Disclaimer && import_react56.default.createElement(Box, {
        marginTop: "28",
        marginX: "32",
        textAlign: "center"
      }, import_react56.default.createElement(Disclaimer, {
        Link: DisclaimerLink,
        Text: DisclaimerText
      })));
      break;
    ...
    case "GET": {
      ...
      walletContent = import_react56.default.createElement(Box, null, import_react56.default.createElement(Box, {
        ...
        return import_react56.default.createElement(Box, {
          ...
          size: "18",
          weight: "bold"
        }, name)), import_react56.default.createElement(ActionButton, {
          href: ios ? downloadUrls == null ? void 0 : downloadUrls.ios : downloadUrls == null ? void 0 : downloadUrls.android,
          label: "GET",
          size: "small",
          type: "secondary"
        })), index < mobileWallets.length - 1 && import_react56.default.createElement(Box, {
          background: "generalBorderDim",
          height: "1",
          marginY: "10",
          width: "full"
  ...
  return import_react56.default.createElement(Box, {
    ...
    paddingX: "20",
    position: "relative"
  }, headerBackButtonLink && import_react56.default.createElement(Box, {
    display: "flex",
    position: "absolute",
    style: {
      left: 0,
    ...
    transition: "default",
    type: "button"
  }, import_react56.default.createElement(BackIcon, null))), import_react56.default.createElement(Box, {
    marginTop: "4",
    textAlign: "center",
    width: "full"
  }, import_react56.default.createElement(Text, {
    ...
    size: "20",
    weight: "bold"
  }, headerLabel)), import_react56.default.createElement(Box, {
    alignItems: "center",
    display: "flex",
    height: "32",
    paddingRight: "14",
  ...
  }, import_react56.default.createElement(CloseButton, {
    onClose
  }))))), import_react56.default.createElement(Box, {
    display: "flex",
    flexDirection: "column"
...
function ConnectOptions({ onClose }) {
  return isMobile() ? import_react40.default.createElement(MobileOptions, {
    onClose
  }) : import_react40.default.createElement(DesktopOptions, {
    onClose
  });
}
function ConnectModal({ onClose, open }) {
  ...
  return !isConnected ? import_react39.default.createElement(Dialog, {
    onClose,
    open,
    titleId
  }, import_react39.default.createElement(DialogContent, {
    bottomSheetOnMobile: true,
    padding: "0",
    wide: true
  }, import_react39.default.createElement(ConnectOptions, {
    onClose
  }))) : null;
}
var units = ["k", "m", "b", "t"];
...
function ConnectButtonRenderer({
  ...
  const preloadImages = (0, import_react10.useCallback)(() => {
    loadImages(...walletConnectors.map((wallet2) => wallet2.iconUrl), ...rainbowKitChains.map((chain) => chain.iconUrl).filter(isNotNullish));
    if (!isMobile()) {
      preloadAssetsIcon();
      preloadLoginIcon();
    }
  ...
  return import_react10.default.createElement(import_react10.default.Fragment, null, children({
    ...
    openChainModal,
    openConnectModal
  }), import_react10.default.createElement(ConnectModal, {
    onClose: closeConnectModal,
    open: connectModalOpen
  }), import_react10.default.createElement(AccountModal, {
    address,
    balanceData,
    ensAvatar,
    ensName,
  ...
  }), import_react10.default.createElement(ChainModal, {
    activeChain,
    chains,
    networkError,
...
function ConnectButton({
  ...
  return import_react.default.createElement(ConnectButtonRenderer, null, ({
    ...
    return import_react.default.createElement(Box, {
    ...
    }, mounted && account ? import_react.default.createElement(import_react.default.Fragment, null, chain && (chains.length > 1 || unsupportedChain) && import_react.default.createElement(Box, {
      alignItems: "center",
      as: "button",
      ...
      display: "flex",
      gap: "6"
    }, chain.hasIcon ? import_react.default.createElement(Box, {
    ...
    }, (_c = chain.name) != null ? _c : chain.id)), import_react.default.createElement(DropdownIcon, null)), !unsupportedChain && import_react.default.createElement(Box, {
      alignItems: "center",
      as: "button",
...
var WalletConnectConnector = class extends Connector {
  ...
  async getProvider() {
    ...
    if (!_classPrivateFieldGet(this, _provider) || chainId || create) {
      ...
      const rpc = !((_this$options = this.options) !== null && _this$options !== void 0 && _this$options.infuraId) ? this.chains.reduce((rpc2, chain) => ({
        ...rpc2,
        [chain.id]: chain.rpcUrls.default
      }), {}) : {};
      const WalletConnectProvider = (await import("./esm-7HBTOUA3.js")).default;
...
var CoinbaseWalletConnector = class extends Connector {
  ...
  async getProvider() {
    if (!_classPrivateFieldGet(this, _provider2)) {
      const chain = this.chains.find((chain2) => chain2.id === this.options.chainId) || this.chains[0];
...
function useAddRecentTransaction() {
  ...
  const { address } = useAccount();
  const chainId = useChainId();
  return (0, import_react57.useCallback)((transaction) => {
    if (!address || !chainId) {
      throw new Error("No address or chain ID found");
    }
